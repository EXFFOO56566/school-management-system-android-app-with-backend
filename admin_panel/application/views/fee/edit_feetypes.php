    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
             Manage Fees Types
            <small>Edit Fees Types</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i>  Manage Fees Types</a></li>
            <li class="active">Edit Fees Types</li>
          </ol>
        </section>
                            ...
                            echo $error;
                                ...
                                <div class="form-group">
                                     ...
                                     <div class="col-md-12">
                                        ...
                                        <select class="form-control select2" name="standard" id="standard" style="width: 100%;">
                                            <?php foreach($school_standard as $standard){
                                                ?>
                                                <option value="<?php echo $standard->standard_id; ?>" <?php if($standard->standard_id == $fee->standard_id){echo "selected";} ?>><?php echo $standard->standard_title; ?></option>
                                                <?php
                                            } ?>
                                        </select>
                                   ...
                                   <div class="col-md-12">
                                        ...
                                        <input type="text" class="form-control" id="fee_title" name="fee_title" value="<?php echo $fee->title; ?>" placeholder="Ex. Education Fee, etc" />
                                    </div>
                                     <div class="col-md-12">
                                        <label for="fee_year">Fees Year <span class="red">*</span></label>
                                        <input type="text" class="form-control" id="fee_year" name="fee_year" value="<?php echo $fee->year; ?>" placeholder="Ex. 2016-17" />
                                    </div>
                                     <div class="col-md-12">
                                        <label for="fee_amount">Fees Amount <span class="red">*</span></label>
                                        <input type="text" class="form-control" id="fee_amount" name="fee_amount" value="<?php echo $fee->base_amount; ?>" placeholder="Ex. 5000" />
                                    </div>
